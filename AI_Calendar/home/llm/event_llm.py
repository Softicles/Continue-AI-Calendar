...
class ExtractInfo:
    ...
    @staticmethod
    def remove_duplicate_and_make_recurrence(event_str: str, api_caller: APICaller) -> list[Event]:
        instruction = (
            f"Group the events that share start time, end time and description which at same day for more than 3 weeks"
            ...
            "Return structured JSON as: {\"title\": ... , \"start\": ... , \"end\": ... , \"location\": ... , \"description\": ... , \"recurrence\": ...}. "
        )
...
class EventExtraction:
    ...
    def extract(self, instruction: str, text: str) -> list[Event]:
        ...
        event_list = ExtractInfo.remove_duplicate_and_make_recurrence(event_str, self.__api_caller)
