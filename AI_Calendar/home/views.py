...
def add_event_to_google(request):
    if request.method == "POST":
        ...
        recurrence_raw = event_data.get("recurrence")
        ...
        if recurrence_raw:
            try:
                recurrence = json.loads(recurrence_raw) if recurrence_raw.startswith('[]') else [recurrence_raw]
                event["recurrence"] = recurrence
            except Exception as e:
                print("Invalid recurrence format:", e)
